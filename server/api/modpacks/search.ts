...
export default (app: Express) => {
    app.get("/api/v1/modpacks/search/:query/:page{/:sort}", async (req, res) => {
        ...
        const result = await database.methods.GetModpackSearch(pageNum, query, sort as "downloads" | "likes" | undefined)
    ...
    return {
        method: "GET",
        route: "/api/v1/modpacks/search/:query/:page{/:sort}"
    }
}