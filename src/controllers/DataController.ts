...
const defaultFiles = [
    {
        ...
        validate: (defaultContent: string, content: string) => {
            ...
            if(!parsedJson.balatro_data_path || typeof(parsedJson.balatro_data_path) !== 'string') {
            ...
            if(!parsedJson.balatro_steam_path || typeof(parsedJson.balatro_steam_path) !== 'string') {
            ...
            if(!parsedJson.profiles_directory || typeof(parsedJson.profiles_directory) !== 'string') {
        ...
        defaultFiles.forEach(file => {
            ...
            switch (file.type) {
                case 'file':
                    ...
                    const replacedContext = file.content
